	...
	<div class="w-full max-w-md">
		<div class="bg-white rounded-2xl shadow-lg border border-stone-200 p-8">
			<div class="text-center mb-8">
				<h1 class="text-3xl font-bold text-[#2c2421]">Welcome back</h1>
				<p class="text-[#8c7b73] mt-2">Sign in to manage your tasks</p>
			</div>
			...
			<div class="mt-6 text-center">
				<p class="text-[#8c7b73] text-sm">
					...
					<a href="/register" class="text-[#e76e50] font-medium hover:underline">Create one</a>
				</p>
			</div>
		</div>
	</div>
